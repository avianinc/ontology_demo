...
# Connect to Fuseki
fuseki_update = FusekiUpdate('http://localhost:3030', 'model')
fuseki_query = FusekiQuery('http://localhost:3030', 'model')

# Define the RDF prefix for our ontology
@rdf_prefix('http://example.org/ontology#')
class RdfPrefix():
    Aircraft: ns
    Payload: ns
    Mission: ns
...
@rdf_property('http://example.org/ontology#')
...
# Example instances
aircraft1 = URIRef('http://example.org/ontology#Aircraft1')
payload1 = URIRef('http://example.org/ontology#Payload1')
fuel_efficiency1 = URIRef('http://example.org/ontology#FuelEfficiency1')
mission1 = URIRef('http://example.org/ontology#Mission1')
mission_success1 = URIRef('http://example.org/ontology#MissionSuccess1')

aircraft2 = URIRef('http://example.org/ontology#Aircraft2')
payload2 = URIRef('http://example.org/ontology#Payload2')
fuel_efficiency2 = URIRef('http://example.org/ontology#FuelEfficiency2')
mission2 = URIRef('http://example.org/ontology#Mission2')
mission_success2 = URIRef('http://example.org/ontology#MissionSuccess2')
